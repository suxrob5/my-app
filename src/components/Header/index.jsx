...
const Header = () => {
  ...
  return (
    <>
      <div className="absolute mt-10 w-[100%] max-w-[1519px] border bg-gray-100">
        <div className=" mx-auto flex w-[80%] items-center justify-between py-5">
            ...
            <ul>
              <li className="text-2xl font-semibold">
                <Link className="mx-3 px-3 py-3" href="/" legacyBehavior>
                  <a
                    className={`mx-3 px-3 py-3
                      ${pathname === "/" ? "border-b-2 border-[#ED165FFF] text-[#ED165FFF]" : "text-black"}
                    `}
                  >
                    Home
                  </a>
                ...
                <Link className="mx-3 px-3 py-3" href="/clothes" legacyBehavior>
                  <a
                    className={`mx-3 px-3 py-3
                     ${pathname === "/clothes" ? "border-b-2 border-[#ED165FFF] text-[#ED165FFF]" : "text-black"}
                   `}
                  >
                    Clothes
                  </a>
                ...
                <Link className="mx-3 px-3 py-3" href="/shoes" legacyBehavior>
                  <a
                    className={`mx-3 px-3 py-3
                      ${pathname === "/shoes" ? "border-b-2 border-[#ED165FFF] text-[#ED165FFF]" : "text-black"}
                    `}
                  >
                    Shoes
                  </a>
                ...
                >
                  <a
                    className={`mx-3 px-3 py-3
                      ${pathname === "/accessories" ? "border-b-2 border-[#ED165FFF] text-[#ED165FFF]" : "text-black"}
                    `}
                  >
                    Accessories
                  </a>
          ...
          <div>
            ...
            <button className="px-3" onClick={() => router.push("myfavorites")}>
              <Image
                src={pathname == "/myfavorites" ? HeartRed : Heart}
                alt="icon"
                className="w-[15px]"
              />
            </button>
